...
<h3 style="text-align: center">Pacienti</h3>
...
<div class="container">';
  ...
  or die('Nu se poate gasi baza de date!');
      ...
      $valuare = 350;//(int)($_POST['valuare']);
      
      $query1 = "SELECT Nume, Prenume, SUM(analize.Pret) as TotalCost
      FROM pacienti
      JOIN buletine ON pacienti.ID_Pacient = buletine.ID_Pacient
      JOIN detalii_buletin ON buletine.ID_Buletin = detalii_buletin.ID_Buletin
      JOIN analize ON detalii_buletin.ID_Analiza = analize.ID_Analiza
      GROUP BY pacienti.ID_Pacient
      HAVING SUM(analize.Pret) = '$valuare'";
